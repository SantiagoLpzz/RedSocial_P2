...
Venta::Venta(int id, Usuario* usuario, string fecha, string contenido, double precio, string lugarDeVenta): Publicacion(id, usuario, fecha, contenido, 0), precio(precio), lugarDeVenta(lugarDeVenta) {
    this->idv = id;
